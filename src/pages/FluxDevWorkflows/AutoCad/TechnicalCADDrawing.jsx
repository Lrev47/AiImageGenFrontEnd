// src/pages/FluxDevWorkflows/TechnicalCADDrawing/TechnicalCADDrawing.jsx
...
import "./TechnicalCADDrawing.css";
import LoadingAnimation from "../../../components/LoadingAnimation";
import LongLoadingAnimation from "../../../components/LongLoadingAmination";

/**
 * Renders the TechnicalCADDrawing Workflow Detail Page.
 * @returns {JSX.Element} - The TechnicalCADDrawing Workflow Page component.
 */
const TechnicalCADDrawing = () => {
  const workflowId = "TechnicalCADDrawing";
  ...
  const FIXED_PROMPT = "A technical CAD drawing of";

  // Model description
  const modelDescription = `
    This workflow generates high-quality technical CAD drawings using AI models fine-tuned for technical illustration styles.
    Features:
    - Generates detailed CAD-style images
    - Post-processing for sharpening and resizing
    - Ideal for engineering and technical visualization
  `;
  ...
  const handleGenerateImage = async () => {
    ...
    try {
      ...
      updatedData.input.workflow["32"].inputs.text = combinedPrompt;
      ...
      updatedData.input.workflow["84"].inputs.noise_seed = randomSeed;
  ...
  return (
    <div className="workflow-page">
      <h1 className="workflow-title">Technical CAD Drawing</h1>
...
export default TechnicalCADDrawing;
