// src/pages/ComfyBundle1/Animaker/Animaker.jsx
...
/**
 * Renders the Animaker Workflow Detail Page.
 * @returns {JSX.Element} - The Animaker Page component.
 */
const Animaker = () => {
  const workflowId = "Animaker";
  ...
  const FIXED_PROMPT = `score_9, score_8_up, score_7_up, score_6_up,`;

  // Model description
  const modelDescription = `
    Animaker is an AI model designed to generate high-quality anime-style images of characters with customizable features. It focuses on creating detailed and expressive illustrations suitable for various creative projects.
  `;
  ...
  const handleGenerateImage = async () => {
    ...
    try {
      ...
      updatedData.input.workflow["15"].inputs.seed = randomSeed + 1;
  ...
  return (
    <div className="workflow-page">
      <h1 className="workflow-title">Animaker</h1>
