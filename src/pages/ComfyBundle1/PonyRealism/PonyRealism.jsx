// src/pages/ComfyBundle1/PonyRealism/PonyRealism.jsx
...
import "./PonyRealism.css";
import LoadingAnimation from "../../../components/LoadingAnimation";
import LongLoadingAnimation from "../../../components/LongLoadingAmination";

/**
 * Renders the PonyRealism Workflow Detail Page.
 * @returns {JSX.Element} - The PonyRealism Page component.
 */
const PonyRealism = () => {
  const workflowId = "PonyRealism";
  ...
  const FIXED_PROMPT = `
score_9, score_8_up, score_7_up, alternative style, depth of field, highly detailed, high contrast, film grain, rim lighting`;

  // Model description
  const modelDescription = `
    PonyRealism is an AI model designed to generate realistic and artistic images with an emphasis on dynamic lighting and alternative styles. Ideal for creating unique portraits and artistic visuals.
  `;
  ...
  return (
    <div className="workflow-page">
      <h1 className="workflow-title">PonyRealism</h1>
