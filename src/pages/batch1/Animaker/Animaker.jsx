...
const Animaker = () => {
  ...
  const modelDescription = `
    Animaker is an AI model designed to generate high-quality anime-style images of characters with customizable features.
    It focuses on creating detailed and expressive illustrations suitable for various creative projects.
  `;
