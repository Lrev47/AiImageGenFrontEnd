...
const CyberRealisticPonyV6 = () => {
  ...
  const modelDescription = `
    CyberRealisticPonyV6.5 is an advanced AI model specialized in generating hyper-realistic images of cybernetic ponies.
    It combines the styles of futuristic cyberpunk aesthetics with the charm of equine figures, allowing you to create
    unique and captivating artwork.
  `;
  ...
  const handleGenerateImage = async () => {
    ...
    try {
      ...
      // Start the job without second argument
